...
const handler = NextAuth({
  ...
  jwt: {
    secret: process.env.NEXTAUTH_SECRET, // used for signing
    encryption: false, // ✅ Disable encryption (must be false)
    signingKey: process.env.NEXTAUTH_SECRET,
    verificationOptions: {
      algorithms: ["HS256"], // ✅ Explicitly set accepted algorithm
    },
  },

  // secret: process.env.NEXTAUTH_SECRET, // same as backend SECRET_KEY
